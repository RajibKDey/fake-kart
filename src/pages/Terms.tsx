function Terms() {
  return (
    <>
      <h1>Terms and Conditions for Fake Kart</h1>

      <h2>Introduction</h2>

      <p>
        These Website Standard Terms and Conditions written on this webpage
        shall manage your use of our website, Fake Kart accessible at
        http://fakekart.com.
      </p>
      ...
      <p>
        Other than the content you own, under these Terms, Fake Kart and/or its
      ...
      <p>
        ...
        and Fake Kart may further restrict access by you to any areas of this
      ...
      <p>
        ...
        display on this Website. By displaying Your Content, you grant Fake Kart
      ...
      <p>
        ...
        rights. Fake Kart reserves the right to remove any of Your Content from
      ...
      <p>
        This Website is provided "as is," with all faults, and Fake Kart express
      ...
      <p>
        In no event shall Fake Kart, nor any of its officers, directors and
        ...
        under contract.  Fake Kart, including its officers, directors and
      ...
      <p>
        You hereby indemnify to the fullest extent Fake Kart from and against
      ...
      <p>
        Fake Kart is permitted to revise these Terms at any time as it sees fit,
      ...
      <p>
        The Fake Kart is allowed to assign, transfer, and subcontract its rights
      ...
      <p>
        These Terms constitute the entire agreement between Fake Kart and you in
